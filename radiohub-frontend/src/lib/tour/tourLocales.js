...
const locales = {
  de: {
    ...
    // === 6. Quell-Sprung ===
    'tour.sj.introTitle': 'Sender starten',
    'tour.sj.introText': 'Spiele zuerst einen Sender ab. Klicke auf eine LED in der Senderliste. Danach zeigen wir dir den Quell-Sprung.',
    'tour.sj.linkTitle': 'Der Quell-Link',
    'tour.sj.linkText': 'In der Steuerung siehst du den Quell-Link (z.B. RADIO). Er zeigt immer woher der Sound kommt -- und ist klickbar!',
    'tour.sj.switchTitle': 'Tab wechseln',
    'tour.sj.switchText': 'Wir wechseln jetzt in die Einstellungen. Die Wiedergabe läuft im Hintergrund weiter.',
    'tour.sj.awayTitle': 'Wiedergabe läuft weiter',
    'tour.sj.awayText': 'Schau in die Steuerung: Der Quell-Link zeigt weiterhin RADIO. Egal in welchem Tab du bist -- er verrät dir immer was gerade spielt.',
    'tour.sj.jumpTitle': 'Jetzt springen!',
    'tour.sj.jumpText': 'Klicke jetzt auf den Quell-Link in der Steuerung! Du springst automatisch zurück zum Tab mit dem spielenden Sender.',
  ...
  en: {
    ...
    // === 6. Source Jump ===
    'tour.sj.introTitle': 'Start a Station',
    'tour.sj.introText': 'First, start playing a station. Click an LED in the station list. Then we will show you the source jump.',
    'tour.sj.linkTitle': 'The Source Link',
    'tour.sj.linkText': 'In the controls you can see the source link (e.g. RADIO). It always shows where the sound comes from -- and it is clickable!',
    'tour.sj.switchTitle': 'Switch Tab',
    'tour.sj.switchText': 'We are switching to Settings now. Playback continues in the background.',
    'tour.sj.awayTitle': 'Playback Continues',
    'tour.sj.awayText': 'Look at the controls: The source link still shows RADIO. No matter which tab you are in -- it always tells you what is playing.',
    'tour.sj.jumpTitle': 'Jump Now!',
    'tour.sj.jumpText': 'Click the source link in the controls now! You will automatically jump back to the tab with the playing station.',
