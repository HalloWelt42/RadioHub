...
export default {
  ...
  cutter: {
    ...
    konvertierenTip: 'Change format and quality',
    konvertierungErfolgreich: 'Conversion complete',
    konvertierungFehler: 'Conversion failed',
    mono: 'MONO',
    monoTip: 'Convert stereo to mono',
    monoErfolgreich: 'Mono conversion complete',
    monoFehler: 'Mono conversion failed',
    formatMP3: 'MP3',
