...
export default {
  ...
  cutter: {
    ...
    konvertierenTip: 'Format und Qualität ändern',
    konvertierungErfolgreich: 'Konvertierung abgeschlossen',
    konvertierungFehler: 'Konvertierung fehlgeschlagen',
    mono: 'MONO',
    monoTip: 'Stereo zu Mono konvertieren',
    monoErfolgreich: 'Mono-Konvertierung abgeschlossen',
    monoFehler: 'Mono-Konvertierung fehlgeschlagen',
    formatMP3: 'MP3',
    formatOGG: 'OGG Vorbis',
    formatAAC: 'AAC',
    qualitaetLow: 'Niedrig',
    qualitaetMedium: 'Standard',
    qualitaetHigh: 'Gut',
    qualitaetBest: 'Maximal',
    auchMono: 'Auch Mono',
